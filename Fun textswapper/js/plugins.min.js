...
!(function (e, t) {
    ...
    function i(e) {
        ...
        for (var n = r(10) ? document.body : null, o = e.offsetParent; o === n && e.nextElementSibling; ) o = (e = e.nextElementSibling).offsetParent;
        var s = o && o.nodeName;
    ...
    function h(e, n) {
        ...
        var v = d({ top: p.top - l.top - m, left: p.left - l.left - g, width: p.width, height: p.height });
        ...
        return (
            (s && !i ? n.contains(u) : n === u && "BODY" !== u.nodeName) &&
                (v = (function (e, t) {
        ...
        if ("viewport" === s)
            l = (function (e) {
                var t = 1 < arguments.length && void 0 !== arguments[1] && arguments[1],
                    ...
                    s = t ? 0 : a(n),
                    f = t ? 0 : a(n, "left");
                return d({ top: s - o.top + o.marginTop, left: f - o.left + o.marginLeft, width: r, height: i });
            })(c, p);
        else {
            var g;
    ...
    function v(e, t, n, o, r) {
        ...
        var s = g(n, o, i, r),
            ...
            a = Object.keys(f)
                .map(function (e) {
                    return X({ key: e }, f[e], { area: ((t = f[e]), t.width * t.height) });
                    var t;
                })
                .sort(function (e, t) {
    ...
    function N(e, t, n, r) {
        (n.updateBound = r), D(e).addEventListener("resize", n.updateBound, { passive: !0 });
        var i = o(e);
        return (
            (function e(t, n, r, i) {
                var s = "BODY" === t.nodeName,
                    f = s ? t.ownerDocument.defaultView : t;
                f.addEventListener(n, r, { passive: !0 }), s || e(o(f.parentNode), n, r, i), i.push(f);
                    ...
                    fn: function (e) {
                        ...
                        if (o) {
                            var r = e.offsets,
                                ...
                                a = f ? "left" : "top",
                                p = f ? "width" : "height",
                                l = { start: _({}, a, i[a]), end: _({}, a, i[a] + i[p] - s[p]) };
                        ...
                        return (
                            s.forEach(function (f, a) {
                                ...
                                (c || b || x) &&
                                    ((e.flipped = !0),
                                    (c || b) && (o = s[a + 1]),
                                    x && (i = "end" === (p = i) ? "start" : "start" === p ? "end" : p),
                                    (e.placement = o + (i ? "-" + i : "")),
                                    (e.offsets.popper = X({}, e.offsets.popper, E(e.instance.popper, e.offsets.reference, e.placement))),
                ...
                computeStyle: {
                    ...
                    fn: function (e, t) {
                        ...
                        var f,
                            ...
                            d = { left: P(r.left), top: M(r.top), bottom: M(r.bottom), right: P(r.right) },
                            h = "bottom" === n ? "top" : "bottom",
                            m = "right" === o ? "left" : "right",
                            g = T("transform");
                        if (((a = "bottom" == h ? -l.height + d.bottom : d.top), (f = "right" == m ? -l.width + d.right : d.left), p && g))
                            (u[g] = "translate3d(" + f + "px, " + a + "px, 0)"), (u[h] = 0), (u[m] = 0), (u.willChange = "transform");
                        else {
                            var v = "bottom" == h ? -1 : 1,
                                b = "right" == m ? -1 : 1;
...
!(function (t, e) {
    ...
    var s,
        ...
        Pn =
                ...
                return (
                    ...
                    (e._removeElement = function (t) {
                        ...
                        if ((s(t).removeClass(g), s(t).hasClass(d))) {
                            ...
                            s(t)
                                .one(kn.TRANSITION_END, function (n) {
            ...
            s(document).on(u.CLICK_DATA_API, '[data-dismiss="alert"]', _._handleDismiss(new _())),
            (s.fn[a] = _._jQueryInterface),
            (s.fn[a].Constructor = _),
        ...
        jn =
            ...
            (D = ".active"),
            (w = ".btn"),
            (N = { CLICK_DATA_API: "click" + y + E, FOCUS_BLUR_DATA_API: (b = "focus") + y + E + " blur" + y + E }),
            (O = (function () {
                function t(t) {
                    this._element = t;
                }
            ...
            (m.fn[p] = O._jQueryInterface),
            (m.fn[p].Constructor = O),
        ...
        Hn =
            ...
            (L = ".data-api"),
            (R = (k = e).fn[P]),
            (x = { interval: 5e3, keyboard: !0, slide: !1, pause: "hover", wrap: !0 }),
            (W = { interval: "(number|boolean)", keyboard: "boolean", slide: "(boolean|string)", pause: "(string|boolean)", wrap: "boolean" }),
            (U = "next"),
            (q = "prev"),
            (F = "left"),
            (K = "right"),
            (M = { SLIDE: "slide" + H, SLID: "slid" + H, KEYDOWN: "keydown" + H, MOUSEENTER: "mouseenter" + H, MOUSELEAVE: "mouseleave" + H, TOUCHEND: "touchend" + H, LOAD_DATA_API: "load" + H + L, CLICK_DATA_API: "click" + H + L }),
            (Q = "carousel"),
            (B = "active"),
            (V = "slide"),
            ...
            (rt = (function () {
                function t(t, e) {
                    (this._items = null),
                        ...
                        (this._element = k(t)[0]),
                        (this._indicatorsElement = this._element.querySelector(et)),
                ...
                return (
                    ...
                    (e.to = function (t) {
                        ...
                        if (!(t > this._items.length - 1 || t < 0))
                            if (this._isSliding)
                                k(this._element).one(M.SLID, function () {
                                    return e.to(t);
                                });
                            else {
                    ...
                    (e.dispose = function () {
                        k(this._element).off(H),
                            k.removeData(this._element, j),
                            (this._items = null),
                            (this._config = null),
                            (this._element = null),
                            (this._interval = null),
                    ...
                    (e._addEventListeners = function () {
                        ...
                        this._config.keyboard &&
                            k(this._element).on(M.KEYDOWN, function (e) {
                                return t._keydown(e);
                            }),
                            "hover" === this._config.pause &&
                                ...
                                "ontouchstart" in document.documentElement &&
                                    k(this._element).on(M.TOUCHEND, function () {
                                        t.pause(),
                    ...
                    (e._triggerSlideEvent = function (t, e) {
                        var n = this._getItemIndex(t),
                            ...
                            r = k.Event(M.SLIDE, { relatedTarget: t, direction: e, from: i, to: n });
                    ...
                    (e._slide = function (t, e) {
                        ...
                        if ((t === U ? ((n = z), (i = J), (r = F)) : ((n = Y), (i = Z), (r = K)), l && k(l).hasClass(B))) this._isSliding = !1;
                        else if (!this._triggerSlideEvent(l, r).isDefaultPrevented() && s && l) {
                            (this._isSliding = !0), h && this.pause(), this._setActiveIndicatorElement(l);
                            var u = k.Event(M.SLID, { relatedTarget: l, direction: r, from: a, to: c });
                            if (k(this._element).hasClass(V)) {
                                ...
                                k(s)
                                    .one(kn.TRANSITION_END, function () {
                                        k(l)
                                            .removeClass(n + " " + i)
                                            .addClass(B),
                                            k(s).removeClass(B + " " + i + " " + n),
                                            (o._isSliding = !1),
                                            setTimeout(function () {
                    ...
                    (t._jQueryInterface = function (e) {
                        return this.each(function () {
                            ...
                            if ((n || ((n = new t(this, i)), k(this).data(j, n)), "number" == typeof e)) n.to(e);
            ...
            k(document).on(M.CLICK_DATA_API, nt, rt._dataApiClickHandler),
            ...
            (k.fn[P] = rt._jQueryInterface),
            (k.fn[P].Constructor = rt),
            (k.fn[P].noConflict = function () {
        ...
        Ln =
            ...
            (ft = { SHOW: "show" + lt, SHOWN: "shown" + lt, HIDE: "hide" + lt, HIDDEN: "hidden" + lt, CLICK_DATA_API: "click" + lt + ".data-api" }),
            (dt = "show"),
            (gt = "collapse"),
            (_t = "collapsing"),
            (mt = "collapsed"),
            ...
            "height",
            (vt = ".show, .collapsing"),
            (yt = '[data-toggle="collapse"]'),
            (Et = (function () {
                function t(t, e) {
                    (this._isTransitioning = !1),
                        (this._element = t),
                        (this._config = this._getConfig(e)),
                        (this._triggerArray = ot.makeArray(document.querySelectorAll('[data-toggle="collapse"][href="#' + t.id + '"],[data-toggle="collapse"][data-target="#' + t.id + '"]')));
                    ...
                    (e.show = function () {
                        ...
                        if (
                            !(
                                ...
                                (this._parent &&
                                    0 ===
                                        (e = [].slice.call(this._parent.querySelectorAll(vt)).filter(function (t) {
                                            return t.getAttribute("data-parent") === i._config.parent;
                                        })).length &&
                                    (e = null),
                                e && (n = ot(e).not(this._selector).data(at)) && n._isTransitioning)
                            )
                        ) {
            ...
            (ot.fn[st] = Et._jQueryInterface),
            (ot.fn[st].Constructor = Et),
        ...
        Rn =
            ...
            (wt = { HIDE: "hide" + St, HIDDEN: "hidden" + St, SHOW: "show" + St, SHOWN: "shown" + St, CLICK: "click" + St, CLICK_DATA_API: "click" + St + It, KEYDOWN_DATA_API: "keydown" + St + It, KEYUP_DATA_API: "keyup" + St + It }),
            (Nt = "disabled"),
            (Ot = "show"),
            "dropup",
            (kt = "dropright"),
            ...
            (Yt = { offset: "(number|string|function)", flip: "boolean", boundary: "(string|element)", reference: "(string|element)", display: "string" }),
            (zt = (function () {
                function t(t, e) {
                ...
                return (
                            ...
                            if ((t._clearMenus(), !i)) {
                                ...
                                if ((Ct(e).trigger(o), !o.isDefaultPrevented())) {
                                    if (!this._inNavbar) {
                                        ...
                                        var s = this._element;
                                        "parent" === this._config.reference ? (s = e) : kn.isElement(this._config.reference) && ((s = this._config.reference), void 0 !== this._config.reference.jquery && (s = this._config.reference[0])),
                                            "scrollParent" !== this._config.boundary && Ct(e).addClass(Ht),
                                            (this._popper = new n(s, this._menu, this._getPopperConfig()));
                                    }
                                    "ontouchstart" in document.documentElement && 0 === Ct(e).closest(Wt).length && Ct(document.body).children().on("mouseover", null, Ct.noop),
                                        this._element.focus(),
                                        this._element.setAttribute("aria-expanded", !0),
                                        Ct(this._menu).toggleClass(Ot),
                                        Ct(e).toggleClass(Ot).trigger(Ct.Event(wt.SHOWN, r));
                                }
                            }
                        }
                    }),
                                    ...
                                    if (Ct(o).hasClass(Ot) && !(e && (("click" === e.type && /input|textarea/i.test(e.target.tagName)) || ("keyup" === e.type && 9 === e.which)) && Ct.contains(o, e.target))) {
                                        ...
                                        Ct(o).trigger(c),
                                            c.isDefaultPrevented() ||
                                                ...
                                                Ct(l).removeClass(Ot),
                                                Ct(o).removeClass(Ot).trigger(Ct.Event(wt.HIDDEN, a)));
                                    }
                                }
                            }
                    }),
                    ...
                    (t._dataApiKeydownHandler = function (e) {
                        if (
                            (/input|textarea/i.test(e.target.tagName) ? !(32 === e.which || (27 !== e.which && ((40 !== e.which && 38 !== e.which) || Ct(e.target).closest(xt).length))) : Dt.test(e.which)) &&
                            (e.preventDefault(), e.stopPropagation(), !this.disabled && !Ct(this).hasClass(Nt))
                        ) {
            ...
            Ct(document)
                .on(wt.KEYDOWN_DATA_API, Lt, zt._dataApiKeydownHandler)
                .on(wt.KEYDOWN_DATA_API, xt, zt._dataApiKeydownHandler)
                .on(wt.CLICK_DATA_API + " " + wt.KEYUP_DATA_API, zt._clearMenus)
                .on(wt.CLICK_DATA_API, Lt, function (t) {
                    t.preventDefault(), t.stopPropagation(), zt._jQueryInterface.call(Ct(this), "toggle");
                })
                .on(wt.CLICK_DATA_API, Rt, function (t) {
                    t.stopPropagation();
                }),
            (Ct.fn[Tt] = zt._jQueryInterface),
            (Ct.fn[Tt].Constructor = zt),
        ...
        xn =
            ...
            (ie = "modal-scrollbar-measure"),
            (re = "modal-backdrop"),
            (oe = "modal-open"),
            (se = "fade"),
            (ae = "show"),
            (le = ".modal-dialog"),
            (ce = '[data-toggle="modal"]'),
            (he = '[data-dismiss="modal"]'),
            ...
            (de = (function () {
                function t(t, e) {
                    (this._config = this._getConfig(e)),
                        (this._element = t),
                        (this._dialog = t.querySelector(le)),
                        (this._backdrop = null),
                        (this._isShown = !1),
                ...
                return (
                    ...
                    (e.show = function (t) {
                        ...
                        if (!this._isTransitioning && !this._isShown) {
                            ...
                            var n = Jt.Event(ne.SHOW, { relatedTarget: t });
                            Jt(this._element).trigger(n),
                                this._isShown ||
                                    ...
                                    this._setScrollbar(),
                                    this._adjustDialog(),
                                    Jt(document.body).addClass(oe),
                                    this._setEscapeEvent(),
                                    this._setResizeEvent(),
                                    Jt(this._element).on(ne.CLICK_DISMISS, he, function (t) {
                                        return e.hide(t);
                                    }),
                        ...
                        if ((t && t.preventDefault(), !this._isTransitioning && this._isShown)) {
                            ...
                            if ((Jt(this._element).trigger(n), this._isShown && !n.isDefaultPrevented())) {
                                ...
                                if (
                                    ...
                                    this._setEscapeEvent(),
                                    this._setResizeEvent(),
                                    Jt(document).off(ne.FOCUSIN),
                                    Jt(this._element).removeClass(ae),
                                    Jt(this._element).off(ne.CLICK_DISMISS),
                                    Jt(this._dialog).off(ne.MOUSEDOWN_DISMISS),
                                    i)
                                ) {
                                    var r = kn.getTransitionDurationFromElement(this._element);
                                    Jt(this._element)
                                        .one(kn.TRANSITION_END, function (t) {
                    ...
                    (e.dispose = function () {
                        Jt.removeData(this._element, Gt),
                            Jt(window, document, this._element, this._backdrop).off($t),
                            (this._config = null),
                            (this._element = null),
                            (this._dialog = null),
                            (this._backdrop = null),
                    ...
                    (e._showElement = function (t) {
                        ...
                        (this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE) || document.body.appendChild(this._element),
                            ...
                            n && kn.reflow(this._element),
                            Jt(this._element).addClass(ae),
                            this._config.focus && this._enforceFocus();
                        var i = Jt.Event(ne.SHOWN, { relatedTarget: t }),
                            r = function () {
                    ...
                    (e._setEscapeEvent = function () {
                        ...
                        this._isShown && this._config.keyboard
                            ? Jt(this._element).on(ne.KEYDOWN_DISMISS, function (e) {
                    ...
                    (e._setResizeEvent = function () {
                        var t = this;
                        this._isShown
                            ? Jt(window).on(ne.RESIZE, function (e) {
                    ...
                    (e._showBackdrop = function (t) {
                        ...
                        if (this._isShown && this._config.backdrop) {
                            if (
                                ...
                                Jt(this._backdrop).appendTo(document.body),
                                Jt(this._element).on(ne.CLICK_DISMISS, function (t) {
                                    e._ignoreBackdropClick ? (e._ignoreBackdropClick = !1) : t.target === t.currentTarget && ("static" === e._config.backdrop ? e._element.focus() : e.hide());
                                }),
                                n && kn.reflow(this._backdrop),
                                Jt(this._backdrop).addClass(ae),
                                !t)
                            )
                                return;
                            if (!n) return void t();
            ...
            (Jt.fn[Zt] = de._jQueryInterface),
            (Jt.fn[Zt].Constructor = de),
            (Jt.fn[Zt].noConflict = function () {
        ...
        Wn =
            ...
            (be = {
                ...
                title: "",
                delay: 0,
                html: !(Te = { AUTO: "auto", TOP: "top", RIGHT: "right", BOTTOM: "bottom", LEFT: "left" }),
                selector: !(Ce = {
                    animation: "boolean",
                    template: "string",
                ...
                return (
                    ...
                    (e.toggle = function (t) {
                        if (this._isEnabled)
                            if (t) {
                                ...
                                n || ((n = new this.constructor(t.currentTarget, this._getDelegateConfig())), ge(t.currentTarget).data(e, n)),
                    ...
                    (e.dispose = function () {
                        clearTimeout(this._timeout),
                            ge.removeData(this.element, this.constructor.DATA_KEY),
                            ge(this.element).off(this.constructor.EVENT_KEY),
                            ge(this.element).closest(".modal").off("hide.bs.modal"),
                            this.tip && ge(this.tip).remove(),
                    ...
                    (e.show = function () {
                        ...
                        if (this.isWithContent() && this._isEnabled) {
                            ...
                            ge(r).data(this.constructor.DATA_KEY, this),
                                ge.contains(this.element.ownerDocument.documentElement, this.tip) || ge(r).appendTo(l),
                                ge(this.element).trigger(this.constructor.Event.INSERTED),
                                ...
                                ge(r).addClass(we),
                                "ontouchstart" in document.documentElement && ge(document.body).children().on("mouseover", null, ge.noop);
                            var c = function () {
                    ...
                    (e.hide = function (t) {
                        var e = this,
                            ...
                            r = function () {
                                e._hoverState !== Se && n.parentNode && n.parentNode.removeChild(n),
                                    e._cleanTipClass(),
                                    e.element.removeAttribute("aria-describedby"),
                                    ge(e.element).trigger(e.constructor.Event.HIDDEN),
                        ...
                        if ((ge(this.element).trigger(i), !i.isDefaultPrevented())) {
                            if (
                                (ge(n).removeClass(we),
                                "ontouchstart" in document.documentElement && ge(document.body).children().off("mouseover", null, ge.noop),
                                (this._activeTrigger.click = !1),
                                (this._activeTrigger[ke] = !1),
                                (this._activeTrigger[Oe] = !1),
                                ge(this.tip).hasClass(De))
                            ) {
                    ...
                    (e._setListeners = function () {
                        ...
                        this.config.trigger.split(" ").forEach(function (e) {
                            if ("click" === e)
                                ge(t.element).on(t.constructor.Event.CLICK, t.config.selector, function (e) {
                                    return t.toggle(e);
                                });
                            else if ("manual" !== e) {
                    ...
                    (e._enter = function (t, e) {
                        ...
                        (e = e || ge(t.currentTarget).data(n)) || ((e = new this.constructor(t.currentTarget, this._getDelegateConfig())), ge(t.currentTarget).data(n, e)),
                            t && (e._activeTrigger["focusin" === t.type ? ke : Oe] = !0),
                            ge(e.getTipElement()).hasClass(we) || e._hoverState === Se
                                ? (e._hoverState = Se)
                    ...
                    (e._leave = function (t, e) {
                        var n = this.constructor.DATA_KEY;
                        (e = e || ge(t.currentTarget).data(n)) || ((e = new this.constructor(t.currentTarget, this._getDelegateConfig())), ge(t.currentTarget).data(n, e)),
                            t && (e._activeTrigger["focusout" === t.type ? ke : Oe] = !1),
                    ...
                    (e._getConfig = function (t) {
                        return (
                            "number" == typeof (t = o({}, this.constructor.Default, ge(this.element).data(), "object" == typeof t && t ? t : {})).delay && (t.delay = { show: t.delay, hide: t.delay }),
                            "number" == typeof t.title && (t.title = t.title.toString()),
                            "number" == typeof t.content && (t.content = t.content.toString()),
                            kn.typeCheckConfig(_e, t, this.constructor.DefaultType),
                            t
                        );
                    }),
            ...
            (ge.fn[_e] = Pe._jQueryInterface),
            (ge.fn[_e].Constructor = Pe),
            (ge.fn[_e].noConflict = function () {
        ...
        Un =
            ...
            (xe = (je = e).fn[He]),
            (We = "bs-popover"),
            (Ue = new RegExp("(^|\\s)" + We + "\\S+", "g")),
            (qe = o({}, Wn.Default, { placement: "right", trigger: "click", content: "", template: '<div class="popover" role="tooltip"><div class="arrow"></div><h3 class="popover-header"></h3><div class="popover-body"></div></div>' })),
            (Fe = o({}, Wn.DefaultType, { content: "(string|element|function)" })),
            "fade",
            (Ke = ".popover-header"),
            (Me = ".popover-body"),
            (Qe = {
            ...
            (je.fn[He] = Be._jQueryInterface),
            (je.fn[He].Constructor = Be),
            (je.fn[He].noConflict = function () {
        ...
        qn =
            ...
            (Xe = { ACTIVATE: "activate" + Je, SCROLL: "scroll" + Je, LOAD_DATA_API: "load" + Je + ".data-api" }),
            (tn = "dropdown-item"),
            (en = "active"),
            (nn = '[data-spy="scroll"]'),
            (rn = ".active"),
            ...
            (dn = (function () {
                function t(t, e) {
                    ...
                    (this._element = t),
                        ...
                        (this._config = this._getConfig(e)),
                        (this._selector = this._config.target + " " + sn + "," + this._config.target + " " + ln + "," + this._config.target + " " + hn),
                        (this._offsets = []),
                        (this._targets = []),
                ...
                return (
                    ...
                    (e.dispose = function () {
                        Ve.removeData(this._element, ze),
                            Ve(this._scrollElement).off(Je),
                            (this._element = null),
                    ...
                    (e._activate = function (t) {
                        ...
                        n.hasClass(tn)
                            ? (n.closest(cn).find(un).addClass(en), n.addClass(en))
                            : (n.addClass(en),
                              n
                                  .parents(on)
                                  .prev(sn + ", " + ln)
                            ...
                            Ve(this._scrollElement).trigger(Xe.ACTIVATE, { relatedTarget: t });
                    }),
                    (e._clear = function () {
            ...
            (Ve.fn[Ye] = dn._jQueryInterface),
            (Ve.fn[Ye].Constructor = dn),
        ...
        Fn =
            ((mn = "." + (_n = "bs.tab")),
            (pn = (gn = e).fn.tab),
            (vn = { HIDE: "hide" + mn, HIDDEN: "hidden" + mn, SHOW: "show" + mn, SHOWN: "shown" + mn, CLICK_DATA_API: "click" + mn + ".data-api" }),
            (yn = "dropdown-menu"),
            (En = "active"),
            (Cn = "disabled"),
            "fade",
            ...
            (In = ".active"),
            (An = "> li > .active"),
            (Dn = '[data-toggle="tab"], [data-toggle="pill"], [data-toggle="list"]'),
            (wn = ".dropdown-toggle"),
            (Nn = "> .dropdown-menu .active"),
            (On = (function () {
                function t(t) {
                    this._element = t;
                }
                ...
                return (
                    (e.show = function () {
                        ...
                        if (!((this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && gn(this._element).hasClass(En)) || gn(this._element).hasClass(Cn))) {
                            ...
                            var s = gn.Event(vn.HIDE, { relatedTarget: this._element }),
                                a = gn.Event(vn.SHOW, { relatedTarget: n });
                            if ((n && gn(n).trigger(s), gn(this._element).trigger(a), !a.isDefaultPrevented() && !s.isDefaultPrevented())) {
                                ...
                                var l = function () {
                                    var e = gn.Event(vn.HIDDEN, { relatedTarget: t._element }),
                                        i = gn.Event(vn.SHOWN, { relatedTarget: n });
            ...
            (gn.fn.tab = On._jQueryInterface),
            (gn.fn.tab.Constructor = On),
...
var PageTransitions = (function () {
    var e,
        ...
        s = !1,
        n = !1,
        c = { WebkitAnimation: "webkitAnimationEnd", OAnimation: "oAnimationEnd", msAnimation: "MSAnimationEnd", animation: "animationend" }[Modernizr.prefixed("animation")],
                ...
                ((window.onhashchange = function () {
                    ...
                    p.each(function () {
                        ...
                        a.indexOf(e) >= 0 &&
                            ...
                            p.eq(a.indexOf(e)).addClass("active"),
                            (function (e) {
                                var a,
                                    p,
    ...
    return (
        ...
        e.indexOf(a) >= 0 && ((r = e.indexOf(a)), p.removeClass("active"), p.eq(e.indexOf(a)).addClass("active")),
        b(),
        { init: b }
    );
})();
...
jQuery(document).ready(function (s) {
    ...
    function u(i) {
        ...
        if (i.parents(".cd-headline").hasClass("type")) {
            ...
            i.parents(".cd-headline").hasClass("clip")
                ? i.parents(".cd-words-wrapper").animate({ width: "2px" }, h, function () {
                      w(i, e), f(e);
                  })
    ...
    function f(s, i) {
        s.parents(".cd-headline").hasClass("type")
            ? (C(s.find("i").eq(0), s, !1, i), s.addClass("is-visible").removeClass("is-hidden"))
            : s.parents(".cd-headline").hasClass("clip") &&
              s.parents(".cd-words-wrapper").animate({ width: s.width() + 10 }, h, function () {
                  setTimeout(function () {
                      u(s);
                  }, p);
              });
                        ...
                        t.proxy(function (t, a) {
                            return (
                                "left" === i && e > a - 30 && e < a + 30
                                    ...
                                    ? (n = t + 1)
                                    : this.op(e, "<", a) && this.op(e, ">", r[t + 1] !== s ? r[t + 1] : a - o) && (n = "left" === i ? t + 1 : t),
                                -1 === n
                            );
                        }, this)
                    ),
    ...
    (function (t, e, i, s) {
        ...
        (n.Defaults = { video: !1, videoHeight: !1, videoWidth: !1 }),
            ...
            (n.prototype.thumbnail = function (e, i) {
                ...
                if ((e.wrap(t("<div/>", { class: "owl-video-wrapper", style: r })), this._core.settings.lazyLoad && ((h = "data-src"), (l = "owl-lazy")), a.length)) return p(a.attr(h)), a.remove(), !1;
                "youtube" === i.type
    ...
    (t.default = (function (e) {
        ...
        if (e) {
            var r = function (e) {
                ...
                z = { minSize: 16, maxSize: 512, multiLine: !0, observeMutations: "MutationObserver" in e && { subtree: !0, childList: !0, characterData: !0 } },
                F = null,
                g = function () {
...
!(function (t) {
        ...
        function o(e) {
            ...
            return function (h) {
                if (
                    ...
                    if ("none" === f.display)
                        return (function () {
                            for (var t = { width: 0, height: 0, innerWidth: 0, innerHeight: 0, outerWidth: 0, outerHeight: 0 }, e = 0, i = r.length; i > e; e++) t[r[e]] = 0;
                            return t;
                        })();
                    var l = {};
    ...
    (function (t, e) {
        ...
        var y =
            "opacity," +
            (c.transform || "transform").replace(/([A-Z])/g, function (t) {
    ...
    (function (t, e) {
        ...
        return (
            ...
            (o.prototype._getItemLayoutPosition = function (t) {
                ...
                for (var n = this._getColGroup(o), r = Math.min.apply(Math, n), s = i.indexOf(n, r), a = { x: this.columnWidth * s, y: r }, u = r + t.size.outerHeight, p = this.cols + 1 - n.length, h = 0; p > h; h++) this.colYs[s + h] = u;
                return a;
            }),
...
!(function (t) {
    ...
    function i(t) {
        ...
        (i.prototype._resetLayout = function () {
            ...
            for (this.columnHeights = []; o--; ) this.columnHeights.push(0);
            ...
            (i.prototype._getItemLayoutPosition = function (t) {
                ...
                for (var n = 0, h = 0; h < e; h++) n = Math.max(n, this.columnHeights[this.currentColumn + h]);
                var s = n + o;
                for (h = 0; h < e; h++) this.columnHeights[this.currentColumn + h] = s;
                var u = { x: this.currentColumn * this.columnWidth, y: n };
    ...
    "function" == typeof define && define.amd ? define(["isotope/js/layout-mode"], i) : i(t.Isotope.LayoutMode);
})(window);
...
!(function (t, e) {
    ...
    var s = o(function (t) {
        ...
        O = o(function (t) {
            ...
            })("versions", []).push({ version: E.version, mode: "global", copyright: "© 2018 Denis Pushkarev (zloirock.ru)" });
        }),
        _ = o(function (t) {
            var e = O("wks"),
                n = s.Symbol,
    ...
    var C = function (t) {
        ...
        B = function (t, e, n) {
            var i,
                ...
                b = p[P] || (p[P] = {});
            l && (n = e);
            for (i in n) (o = ((r = !a && d && void 0 !== d[i]) ? d : n)[i]), (c = f && r ? W(o, s) : h && "function" == typeof o ? W(Function.call, o) : o), d && S(d, i, o, t & B.U), p[i] != o && v(p, i, c), h && b[i] != o && (b[i] = o);
        };
    ...
    var V,
        ...
        Z =
            ...
            function (t, e, n) {
                ...
                if (V && e != e) {
                    for (; c > a; ) if ((o = s[a++]) != o) return !0;
                } else for (; c > a; a++) if ((V || a in s) && s[a] === e) return V || a || 0;
                return !V && -1;
            }),
        tt = Q("IE_PROTO"),
            ...
            function (t) {
                return (function (t, e) {
                    var n,
                        ...
                        r = 0,
                        o = [];
                    for (n in i) n != tt && b(i, n) && o.push(n);
                    for (; e.length > r; ) b(i, (n = e[r++])) && (~Z(o, n) || o.push(n));
                    return o;
                })(t, et);
            },
        it = i
            ...
            : function (t, n) {
                  e(t);
                  for (var i, r = nt(n), o = r.length, s = 0; o > s; ) f.f(t, (i = r[s++]), n[i]);
                  return t;
              },
        rt = s.document,
        ...
        lt = function () {
            var t,
                e = l("iframe"),
                n = et.length;
            for (e.style.display = "none", ot.appendChild(e), e.src = "javascript:", (t = e.contentWindow.document).open(), t.write("<script>document.F=Object</script>"), t.close(), lt = t.F; n--; ) delete lt[at][et[n]];
            return lt();
        },
        ut =
            Object.create ||
            function (t, n) {
                var i;
                return null !== t ? ((ct[at] = e(t)), (i = new ct()), (ct[at] = null), (i[st] = t)) : (i = lt()), void 0 === n ? i : it(i, n);
            },
        ht = f.f,
        ft = _("toStringTag"),
        dt = function (t, e, n) {
            t && !b((t = n ? t : t.prototype), ft) && ht(t, ft, { configurable: !0, value: e });
        },
        vt = {};
    ...
    var pt = function (t) {
        ...
        Ot = (function (t, e, n, i, r, o, s) {
            var c, a, l;
            (a = e), (l = i), ((c = n).prototype = ut(vt, { next: d(1, l) })), dt(c, a + " Iterator");
            var u,
                h,
                f,
                p = function (t) {
            ...
            if (
                (_ && (f = mt(_.call(new t()))) !== Object.prototype && f.next && (dt(f, b, !0), "function" != typeof f[gt] && v(f, gt, wt)),
                y &&
                    E &&
                    E.name !== St &&
                    ((m = !0),
                ...
                if (((u = { values: y ? w : p(St), keys: o ? w : p("keys"), entries: O }), s)) for (h in u) h in g || S(g, h, u[h]);
    ...
    for (
        ...
        var Tt,
            ...
            jt = s[zt],
            Dt = jt && jt.prototype;
        if (Dt && (Dt[_t] || v(Dt, _t, xt), Dt[kt] || v(Dt, kt, zt), (D[zt] = xt), Ct)) for (Tt in Ot) Dt[Tt] || S(Dt, Tt, Ot[Tt], !0);
    }
    var Yt = function (t, n, i, r) {
            try {
                ...
                return (
                    ...
                    D[
                        ...
                        void 0 === e
                            ...
                            : Pt
                            ? N(n)
                            : "Object" == (r = N(n)) && "function" == typeof n.callee
                            ? "Arguments"
                            : r)
                    ]
                );
        ...
        "Array",
        {
            from: function (t) {
                var e,
                    ...
                    h = 0,
                    f = Vt(s);
                if ((u && (l = W(l, a > 2 ? arguments[2] : void 0, 2)), void 0 != f && (c != Array || void 0 === (o = f) || (D.Array !== o && Xt[Nt] !== o))))
                    for (r = f.call(s), n = new c(); !(i = r.next()).done; h++) Rt(n, h, u ? Yt(r, l, [i.value, h], !0) : i.value);
                else for (n = new c((e = U(s.length))); e > h; h++) Rt(n, h, u ? l(s[h], h) : s[h]);
                return (n.length = h), n;
            },
        }
    );
    var Ht = { f: Object.getOwnPropertySymbols },
        Gt = { f: {}.propertyIsEnumerable },
        It = Object.assign,
        Ut =
            !It ||
            n(function () {
                ...
                ? function (t, e) {
                      for (var n = pt(t), i = arguments.length, r = 1, o = Ht.f, s = Gt.f; i > r; )
                          for (var c, a = X(arguments[r++]), l = o ? nt(a).concat(o(a)) : nt(a), u = l.length, h = 0; u > h; ) s.call(a, (c = l[h++])) && (n[c] = a[c]);
                      return n;
                  }
                : It;
    function $t(t, e) {
    ...
    function fe(t, e, n) {
        ...
        return (
            (e = ve(e) || 0),
            de(n) && ((u = !!n.leading), (o = (h = "maxWait" in n) ? le(ve(n.maxWait) || 0, e) : o), (f = "trailing" in n ? !!n.trailing : f)),
            (y.cancel = function () {
    ...
    var pe = function (t, e, n) {
            var i = !0,
                r = !0;
            if ("function" != typeof t) throw new TypeError(Kt);
            return de(n) && ((i = "leading" in n ? !!n.leading : i), (r = "trailing" in n ? !!n.trailing : r)), fe(t, e, { leading: i, maxWait: e, trailing: r });
        },
        be = (function () {
    ...
    var De = function (t, e) {
            var n,
                ...
                l =
                    ...
                    _e(a, { x: i, y: r, width: o, height: s, top: r, right: i + o, bottom: s + r, left: i }),
                    a);
            _e(this, { target: t, contentRect: l });
        },
        Ye = function (t, e, n) {
        ...
        Pe = (function () {
            function t(e, n) {
                ...
                !(function (t, e) {
                    ...
                    (this.offsetSize = 20),
                    (this.recalculate = pe(this.recalculate.bind(this), 1e3)),
                    this.init();
            }
            var e, n, i;
            return (
                                            ...
                                            Array.from(e.addedNodes).forEach(function (e) {
                                                1 === e.nodeType &&
                                                    (e.hasAttribute("data-simplebar")
                                                        ...
                                                        : Array.from(e.querySelectorAll("[data-simplebar]")).forEach(function (e) {
                                                              !e.SimpleBar && new t(e, t.getElOptions(e));
                                                          }));
                                            }),
                                                Array.from(e.removedNodes).forEach(function (t) {
                                                    1 === t.nodeType &&
                                                        (t.hasAttribute("data-simplebar")
                                                            ...
                                                            : Array.from(t.querySelectorAll("[data-simplebar]")).forEach(function (t) {
                                                                  t.SimpleBar && t.SimpleBar.unMount();
                                                              }));
                                                });
                                        });
                    ...
                    },
                    {
                        ...
                        get: function () {
                            return {
                                autoHide: !0,
                                forceVisible: !1,
                                classNames: { content: "simplebar-content", scrollContent: "simplebar-scroll-content", scrollbar: "simplebar-scrollbar", track: "simplebar-track" },
                                scrollbarMinSize: 25,
                                scrollbarMaxSize: 0,
                                direction: "ltr",
                                timeout: 1e3,
                ...
                (n = [
                        ...
                        value: function () {
                            ...
                            this.options.autoHide && this.el.addEventListener("mouseenter", this.onMouseEnter),
                                ...
                                "undefined" != typeof MutationObserver &&
                                    ...
                                    this.mutationObserver.observe(this.el, { attributes: !0, childList: !0, characterData: !0, subtree: !0 })),
                                (this.resizeObserver = new Re(this.recalculate)),
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            "x" === r
                                ? ((t = this.scrollbarX), (e = this.contentEl[this.scrollOffsetAttr[r]]), (n = this.contentSizeX), (i = this.trackXSize))
                                : ((t = this.scrollbarY), (e = this.scrollContentEl[this.scrollOffsetAttr[r]]), (n = this.contentSizeY), (i = this.trackYSize));
                            var o = e / (n - i),
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            this.isVisible[e] ||
                                ((t = "x" === e ? this.scrollbarX : this.scrollbarY),
                                this.isEnabled[e] && (t.classList.add("visible"), (this.isVisible[e] = !0)),
    ...
    return (
        (t.fn.tilt = function (i) {
            var s = function () {
                ...
                a = function (i) {
                    return void 0 === i && (i = { pageX: t(this).offset().left + t(this).outerWidth() / 2, pageY: t(this).offset().top + t(this).outerHeight() / 2 }), { x: i.pageX, y: i.pageY };
                },
                r = function (t) {
                ...
                slide: function (i, t) {
                    ...
                    e.css({ left: i.upcoming_position, display: "block" }),
                        s.$control.animate({ left: i.offset }, s.options.animation_speed, s.options.animation_easing, function () {
                            s.size() > 1 && (s.$control.css({ left: -s.width }), n.eq(i.upcoming_slide).css({ left: s.width, zIndex: 2 }), i.outgoing_slide >= 0 && n.eq(i.outgoing_slide).css({ left: s.width, display: "none", zIndex: 0 })),
                                t();
                        });
                },
                fade: function (i, t) {
    ...
    function b(a) {
        ...
        for (
            f = a
                ...
                h = 0,
                g = f.length;
            h < g && ((c = f[h]), c.search(/^(http|https|ftp):\/\//) === -1 && c.search(":") !== -1);
            h++
        )
    ...
    (e.prototype.init = function () {
        ...
        (e = f.$wrapper = a("<div>")
            ...
            "object" == typeof g
                ...
                : (b = f.$video = a('<video><source src="' + g + '.mp4" type="video/mp4"><source src="' + g + '.webm" type="video/webm"><source src="' + g + '.ogv" type="video/ogg"></video>'));
        try {
